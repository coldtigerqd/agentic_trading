...
Market Data Skill exposes market data query functions to Claude Code, enabling Commander and Swarm agents to access historical OHLCV data for analysis and decision-making.
...
- **Depends on**: `market-data-storage` for querying cached data
- **Depends on**: `data-fetcher-service` for lazy backfill
- **Used by**: Commander agent for decision-making
- **Used by**: Swarm instances for strategy analysis
