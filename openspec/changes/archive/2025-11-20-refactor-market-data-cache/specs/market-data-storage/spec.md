# Capability: Market Data Storage
...
Market Data Storage provides SQLite schema and management functions for storing 3 years of historical OHLCV (Open, High, Low, Close, Volume) bars at 5-minute granularity.
...
- **Used by**: `data-fetcher-service` for inserting fetched data
- **Used by**: `market-data-skill` for querying historical data
- **Depends on**: `data-persistence` for SQLite database infrastructure
